...
public class ScoutConfig {
	...
	public static void loadConfig() {
		try {
			...
			if (config.exists() && config.isFile()) {
				...
				File defaultConfig = new File(Services.PLATFORM.getConfigDir().getParent().toFile(), "defaultconfigs/scout.css");
	...
	private static File getConfigFile() {
		return new File(Services.PLATFORM.getConfigDir().toFile(), "scout.css");
	}
